...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference("Coin.count") do
      post coins_url, params: { coin: { acronyum: @coin.acronyum, description: @coin.description, url_img: @coin.url_img } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronyum: @coin.acronyum, description: @coin.description, url_img: @coin.url_img } }
